...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.78\textwidth]{Figures/F4.1_fases_sistema.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.98\textwidth]{Figures/F4.23_flujo_datos.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/F4.20_diseno_modular_justificacion.png}
