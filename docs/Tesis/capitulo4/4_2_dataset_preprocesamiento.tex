...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.99\textwidth]{Figures/F4.21_proceso_anotacion.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.99\textwidth]{Figures/F4.4_clahe_comparacion.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/F4.17_division_dataset.png}
