...
\begin{figure}[htbp]
    ...
    \caption{Diagrama del flujo de inferencia y del protocolo de evaluación. La parte superior resume el pipeline desde la radiografía de entrada hasta la predicción final; la parte inferior muestra la partición estratificada y el uso de validación y prueba para reportar métricas.}
