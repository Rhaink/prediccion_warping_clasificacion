...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.99\textwidth]{Figures/F4.15_flujo_inferencia_evaluacion.png}
    \caption{Diagrama del flujo de inferencia y del protocolo de evaluación. La parte superior resume el proceso desde la radiografía de entrada hasta la predicción final; la parte inferior muestra la partición y el uso de validación y prueba para reportar métricas.}
    \label{fig:flujo_inferencia_evaluacion}
\end{figure}
...
Las evaluaciones se realizaron en el siguiente entorno de hardware:
...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}ll@{}}
        ...
        GPU & AMD Radeon Graphics (integrada, ROCm 6.0) \\
        RAM & 16 GB DDR4 \\
...
\label{subsec:disponibilidad_codigo}

La implementación completa del sistema está disponible públicamente en \url{https://github.com/Rhaink/LungAlignment}, permitiendo la reproducción de todos los experimentos reportados en esta tesis. El repositorio se presentan en el Anexo~\ref{anexo:codigo_fuente}.
