...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.98\textwidth]{Figures/coord_attention_v10_mechanism_real.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{Figures/F4.24_cabeza_regresion.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.98\textwidth]{Figures/F4.16_estrategia_entrenamiento_ensemble_tta.png}
