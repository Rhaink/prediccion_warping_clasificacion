...
\textbf{Paso 1: Centrado (eliminación de posición).} Cada configuración de puntos de referencia se desplaza para que su centro geométrico coincida con el origen de coordenadas. El centro se calcula como el promedio de las coordenadas de todos los puntos de referencia.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.99\textwidth]{Figures/F4.19_rotacion_optima_svd.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.80\textwidth]{Figures/F4.7_proceso_gpa_es.png}
...
La Figura \ref{fig:gpa_proceso} ilustra el proceso de GPA aplicado al conjunto de puntos de referencia.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.60\textwidth]{Figures/F4.8_triangulacion_delaunay_es.png}
...
\subsubsection{Aplicación a los Puntos de Referencia}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.90\textwidth]{Figures/F4.9_original_vs_warped_es.png}
...
El \textit{Warping} (deformación) es el proceso de ``estirar'' o ``comprimir'' partes de la imagen para que los puntos de referencia del paciente coincidan con los puntos de referencia de la forma estándar. Se denomina ``por partes'' porque cada triángulo se transforma de manera independiente \cite{wolberg1990digital}.

\paragraph{Analogía visual.}
Imaginemos la imagen impresa en una hoja de goma elástica, con los puntos de referencia marcados como puntos. La deformación consiste en ``tirar'' de cada punto de referencia hasta que coincida con su posición en la forma estándar. Los triángulos actúan como regiones que se estiran de manera uniforme: si un vértice del triángulo se mueve, toda la región triangular se deforma proporcionalmente.
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.99\textwidth]{Figures/F4.22_transformacion_triangulo.png}
...
\begin{enumerate}
    \item Se identifican los tres vértices del triángulo en la imagen original (puntos de referencia predichos) y en la forma estándar.
...
\label{alg:warping}
\begin{algorithmic}[1]
\Require Imagen original, puntos de referencia de la imagen, puntos de referencia de la forma estándar, triangulación
...
\begin{enumerate}
    \item \textbf{Predicción de puntos de referencia:} El modelo de detección (descrito en la Sección \ref{sec:modelo_landmarks}) localiza los 15 puntos del contorno pulmonar en la radiografía de entrada.
