...
\begin{enumerate}
    ...
    \item \textbf{La normalización geométrica aprende características genuinas:} El sistema propuesto (98.60\%) alcanza alto rendimiento utilizando únicamente la región pulmonar, sin acceso a artefactos periféricos.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}p{1cm}p{6cm}p{5.5cm}c@{}}
        ...
        ResNet-18: 98.10\% accuracy; PCA-Fisher-KNN: 80.44\%. Ambos mejoran con normalización (+2.74 pp y +3.38 pp respectivamente) (Cap. 5.3) &
        \checkmark \\
        \midrule
        4 & Validar el clasificador mediante métricas y validación cruzada &
        Exactitud, F1-Score, matrices de confusión. Validación cruzada k=5: 98.60\% $\pm$ 0.26\% (Cap. 5.3) &
        \checkmark \\
        \midrule
        5 & Contrastar resultados con/sin alineación &
        Original: 98.68\%, Normalizado: 98.10\%, Recortado: 95.36\%. Evidencia de características espurias (Cap. 5.4) &
        \checkmark \\
        \bottomrule
    \end{tabular}
\end{table}
