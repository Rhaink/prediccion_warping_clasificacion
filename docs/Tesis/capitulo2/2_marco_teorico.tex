...
\textbf{Jerarqu\'ia de features en CNNs:}
...
\begin{itemize}
    ...
    \item \textbf{Capas profundas (Conv5):} Aprenden features espec\'ificas de la
...
\begin{itemize}
    ...
    Demostraron que features de capas iniciales son gen\'ericas y transferibles,
...
(predecir 30 coordenadas) utilizando features fijas del extractor de caracter\'isticas. Al finalizar
...
\begin{itemize}
    \item \textbf{Congelar todo:} El modelo se vuelve un extractor de features
    fijo. Puede sufrir \textit{underfitting} si las features de ImageNet no son
...
DenseNet-121 \cite{huang2017densely} & 8.0M & 121 & 74.4\% & Eficiente, reutiliza features \\
