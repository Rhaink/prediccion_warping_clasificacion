...
\midrule
\textbf{Este trabajo (2026)} & \textbf{Pulmón (15~pts)} & \textbf{3.61\,px (224$\times$224)} & \textbf{1.14} & \textbf{Wing Loss + Ensamble + TTA} \\
\cmidrule{3-4}
...
\item[b] Mejor modelo individual (semilla 456), ensamble reportado en fila principal
