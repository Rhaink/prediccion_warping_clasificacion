...
Warped$\to$Warped (98.73\%), y Warped$\to$Original (95.57\%). El hallazgo
más significativo es la asimetría en la generalización: mientras que los
modelos entrenados en original sufren una degradación del 7.70\% al
evaluarse en warped, los modelos entrenados en warped solo pierden 3.17\%
...
con una mejora en generalización de 2.4× respecto al modelo original
(corregido de 11× en Sesión 39 mediante cross-evaluation con 3 clases idénticas).
...
\midrule
\textbf{Original} & \cellcolor{green!20}98.84\% & \cellcolor{red!20}91.13\% & \textbf{7.70\%} \\
\textbf{Warped} & \cellcolor{yellow!20}95.57\% & \cellcolor{green!20}98.73\% & \textbf{3.17\%} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Original & Accuracy & 98.84\% & 91.13\% \\
& Gap absoluto & \multicolumn{2}{c}{7.70 puntos} \\
& Gap relativo & \multicolumn{2}{c}{-7.79\%} \\
\midrule
Warped & Accuracy & 98.73\% & 95.57\% \\
& Gap absoluto & \multicolumn{2}{c}{3.17 puntos} \\
& Gap relativo & \multicolumn{2}{c}{-3.20\%} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{equation}
R = \frac{\text{Gap}_{\text{Original}}}{\text{Gap}_{\text{Warped}}} =
\frac{7.70\%}{3.17\%} = \textbf{2.43}
\end{equation}

\begin{resultadoimportante}[title={Mejora de 2.4× en generalización (Corregido Sesión 39)}]
El modelo entrenado en imágenes warped generaliza \textbf{2.4 veces mejor}
que el modelo entrenado en originales. Este resultado fue corregido en Sesión 39
mediante cross-evaluation con datasets de 3 clases idénticas (el claim anterior
de 11× comparaba datasets con diferente número de clases).
\begin{enumerate}
    \item El modelo original tiene gap de generalización de 7.70\%
    \item El modelo warped tiene gap de generalización de 3.17\%
    \item La normalización geométrica contribuye \textasciitilde25\% adicional
    a la robustez (el \textasciitilde75\% restante viene de reducción de información)
\end{enumerate}
...
\begin{enumerate}
    ...
    \item \textbf{Justificación}: La mejora de 2.4× en generalización
    es significativa y el modelo warped mantiene 98.73\% accuracy
\end{enumerate}
...
\textbf{Elementos visuales}:
\begin{itemize}
    \item Dos barras: Gap Original (7.70\%), Gap Warped (3.17\%)
    \item Anotación del ratio (2.4×)
...
\begin{enumerate}
    ...
    warped generalizan mejor (gap 3.17\%) que los entrenados en
    original (gap 7.70\%) - datos corregidos en Sesión 39.

    \item \textbf{Ratio de mejora de 2.4×}: La normalización geométrica
    produce modelos con capacidad de generalización 2.4 veces superior
    (corregido de 11× en Sesión 39).
