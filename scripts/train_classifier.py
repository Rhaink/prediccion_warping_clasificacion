#!/usr/bin/env python3
"""
Sesion 22: Entrenamiento de clasificador CNN para COVID/Normal/Viral_Pneumonia
sobre dataset warpeado (forma canonica).

Caracteristicas:
- Transfer learning con ResNet-18 o EfficientNet-B0
- Class weights para manejar desbalance
- Imagenes warpeadas 224x224 (solo area pulmonar)
"""
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"Iniciando entrenamiento: {args.epochs} epocas")
    print(f"{'='*60}\n")
    ...
    # Guardar modelo
    model_path = output_dir / 'best_classifier.pt'
    torch.save({
    ...
    print(f"Dataset: warped (forma canonica)")
